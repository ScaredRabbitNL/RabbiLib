package io.github.scaredsmods.rabbilib.api.crafting.blockentity;
 ...
 * Use {@link ContainerHelper#saveAllItems(CompoundTag, NonNullList, HolderLookup.Provider)} (NbtCompound, DefaultedList, RegistryWrapper.WrapperLookup)} and
 * {@link ContainerHelper#loadAllItems(CompoundTag, NonNullList, HolderLookup.Provider)} (NbtCompound, DefaultedList, RegistryWrapper.WrapperLookup)}
...
public interface ImplementedInventory extends WorldlyContainer {
     ...
     *
     * <p>The default implementation uses {@link ContainerHelper#takeItem(List, int)} (List, int)}
     *
     * @param slot the slot
